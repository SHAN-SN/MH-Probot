...
async def start(client, message):
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_message(
            ...
            text="**നിങ്ങൾ ഞങ്ങളുടെ ചാനലിൽ ഇതുവരെ ജോയിൻ ചെയ്തിട്ടില്ല ജോയിൻ ചെയ്താൽ മാത്രമേ സിനിമകൾ കിട്ടുകയുള്ളൂ അതുകൊണ്ട് താഴെ കാണുന്ന 🎭 JOIN OUR CHANNEL 📣 എന്ന ബട്ടണിൽ ക്ലിക്ക് ചെയ്തു ഞങ്ങളുടെ ചാനലിൽ ജോയിൻ ചെയ്തതിന് ശേഷം വീണ്ടും താഴെ കാണുന്ന 🔄 Try Again എന്ന ബട്ടണിൽ ക്ലിക്ക് ചെയ്യുക സിനിമ കിട്ടും 😉\n\n[ You Have Not Yet Joined Our Channel  Please Try Again After Joining ]**",
